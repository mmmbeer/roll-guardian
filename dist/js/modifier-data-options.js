...
export const SUPPORT_EFFECTS = [
  ...
  effect("guidance", "Guidance", "Spells & support", "Add 1d4 to an eligible ability check.", [die(["skill"], "1d4", "Guidance")]),
  effect("resistance-spell", "Resistance", "Spells & support", "Add 1d4 to an eligible saving throw.", [die(["save"], "1d4", "Resistance")]),
  effect("bardic-inspiration", "Bardic Inspiration", "Spells & support", "Add the configured Bardic Inspiration die to an eligible d20 roll.", [die(["attack", "skill", "save"], "1d8", "Bardic Inspiration")], BOTH, { configurable: "die" }),
