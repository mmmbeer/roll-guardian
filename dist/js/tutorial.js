import { $, openModal, closeModal, renderAppliedModifiers, renderDiceLoadout } from "./ui.js?v=1.7.0";
import { buildRollPlan } from "./roll-engine.js?v=1.7.0";
import { createDefaultState } from "./state.js?v=1.7.0";

const KEY = "rollGuardian.tutorial.v1";
const STEPS = [
  ["Your character and rules", '.topbar-actions', "Choose 2014 or 2024 rules. Open Character and use its tabs to import a sheet or edit abilities, gear, and spells. Start blank clears the character and remembered modifiers for unmodified rolls. Your character and choices are saved in this browser."],
  ...
  ["Tell the app what applies", '.modifier-tools', "Use ＋ Modifiers on the bottom options bar for choices that apply to this roll. The top bar groups conditions, support spells, combat options, and features. Search finds modifiers across the whole catalog. Configure sets dice, values, or the source bard’s level. You decide whether each feature’s trigger is met."],
